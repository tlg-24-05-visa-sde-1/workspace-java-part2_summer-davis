...
public interface Catalog {
   ...
   * method.
   *
   * <p>A match is defined as any item whose title or artist contains the keyword. Searches are to
   * be case insensitive.
   *
   * <p>A no-matches result should return an empty collection (not null).
   */
