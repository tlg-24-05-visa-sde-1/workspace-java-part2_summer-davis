...
public class Catalog {
    ...
    /**
     * Searches catalog by one or more brands, and returns a map with an entry (row) for each brand supplied,
    ...
    public static Map<String,Collection<Television>> findByBrands(String... brands) {
        ...
        for (String brand : brands) {
            Collection<Television> entry = findByBrand(brand);
            result.put(brand, entry);
        }
        return result;
    }
